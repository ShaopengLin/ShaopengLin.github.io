...
As a software engineer, I have a strong interest in low-level and hardware-centric programming, with over two years of experience in **C/C++** and **Python**. I also have experience in **compiler** engineering and **Qt**-based GUI development. I previously interned at Huawei Canada and participated in Google Summer of Code (**GSOC**) through open-source contributions. In my spare time, I enjoy working on Android apps, graphics computing, and game development.
